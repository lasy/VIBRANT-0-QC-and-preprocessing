...
There remains two participants for whom CRF35 claims that softcups were collected but for whom we do not have any data.
...
:::callout-caution
One well appears to have a very low bead count; we will flag this sample as "failed" in the section @sec-filtering below. 
:::
