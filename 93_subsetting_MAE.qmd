...
- `MAE_2`: contains all necessary data for the second VIBRANT paper describing in more details the dynamics of the microbiota and of colonization following metronidazole treatment and LBP intervention.  
- ...
...
## MAE 5 (Acceptability - qualitative and quantitative study)
...
`mae_6` contains all necessary information and data for the "BV diagnosis" paper led by Meilin Zhu which aims at comparing BV diagnosis frameworks (Amsel criteria, Nugent scores, and molecular composition) across sites.
