...
) |> sort(decreasing = TRUE) |> str_subset("2025-05-29")

# crf_data_path <- fs::dir_ls(
#   "/Users/lvermeren/OneDrive - UCL/VIBRANT clinical data/Data processed/") |> sort(decreasing = TRUE) |> magrittr::extract(1) #LV
...
load(str_c(crf_data_path, "/participant_crfs_merged.RData"), verbose = TRUE)
...
load(str_c(crf_data_path, "/visits_crfs_merged.RData"), verbose = TRUE)
